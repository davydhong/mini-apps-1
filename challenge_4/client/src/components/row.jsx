...
var Row = props => {
	...
	for (let i = 0; i < props.col; i++) {
		arr[i] = <Col x={props.row} y={i} handlePlacerMouseEnter={props.handlePlacerMouseEnter} handlePlacerMouseLeave={props.handlePlacerMouseLeave} handlePlaceDisc={props.handlePlaceDisc} />;
	}
	// }
